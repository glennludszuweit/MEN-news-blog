...
var showAlert = function showAlert(type, msg) {
  hideAlert();
  var markup = "<div class=\"text-center alert alert-".concat(type, "\">").concat(msg, "</div>");
...
var register = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(signupName, signupEmail, signupPassword, confirmPassword) {
    var res;
...
var login = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(signinEmail, signinPassword) {
    var res;
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"comments.js":[function(require,module,exports) {
"use strict";
...
var comment = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(user, post, _comment) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              (0, _alert.showAlert)('success', 'Comment Added!');
            }
  ...
  return function comment(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
...
var updateComment = /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            id = document.getElementById('updateCommentId').value;
            _context2.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              ...
              (0, _alert.showAlert)('success', 'Comment Updated!');
            }
  ...
  return function updateComment(_x4) {
    return _ref2.apply(this, arguments);
  };
}();
...
var updateCommentForm = document.querySelector('.update-comment'); //DELEGATION
...
if (registerForm) {
  registerForm.addEventListener('submit', function (e) {
    ...
    (0, _auth.register)(signupName, signupEmail, signupPassword, confirmPassword);
  });
}
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    ...
    (0, _auth.login)(signinEmail, signinPassword);
  });
}
...
if (createNewPostForm) {
  createNewPostForm.addEventListener('submit', function (e) {
    ...
    form.append('description', document.getElementById('postDescription').value);
    form.append('introduction', document.getElementById('postIntroduction').value);
    form.append('content', document.getElementById('postContent').value);
    console.log(form);
    (0, _post.newPost)(form);
  });
}
...
if (commentForm) {
  commentForm.addEventListener('submit', function (e) {
    ...
    var commentPostId = document.getElementById('commentPostId').value;
    var commentMessage = document.getElementById('comment-message').value;
    (0, _comments.comment)(commentUserId, commentPostId, commentMessage);
  });
}
